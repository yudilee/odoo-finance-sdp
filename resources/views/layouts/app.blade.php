...
<body class="bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-200 min-h-screen flex" 
    ...
    <aside :class="sidebarOpen ? 'w-64' : 'w-16'" class="bg-slate-800 dark:bg-slate-950 text-white flex flex-col transition-all duration-300 fixed h-full z-[60]">
        ...
        <nav class="flex-1 p-3 space-y-1 overflow-y-auto">
            ...
            <a href="{{ route('uninvoiced-rentals.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors {{ request()->routeIs('uninvoiced-rentals.*') ? 'bg-violet-600/30 text-violet-300' : 'hover:bg-slate-700 text-slate-300' }}">
                ...
                <span x-show="sidebarOpen" x-cloak>Uninvoiced Rental</span>
            </a>
            <a href="{{ route('invoice-subscription.accounting-report') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors {{ request()->routeIs('invoice-subscription.accounting-report') ? 'bg-violet-600/30 text-violet-300' : 'hover:bg-slate-700 text-slate-300' }}">
                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                <span x-show="sidebarOpen" x-cloak>Accounting Report</span>
            </a>
            <a href="{{ route('credit-notes.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors {{ request()->routeIs('credit-notes.*') ? 'bg-violet-600/30 text-violet-300' : 'hover:bg-slate-700 text-slate-300' }}">
                <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                <span x-show="sidebarOpen" x-cloak>Credit Notes Report</span>
            </a>
            @endif
            ...
            <a href="{{ route('admin.reset_inv_counter.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors {{ request()->routeIs('admin.reset_inv_counter*') ? 'bg-emerald-600/30 text-emerald-300' : 'hover:bg-slate-700 text-slate-300' }}">
                ...
                <span x-show="sidebarOpen" x-cloak>Reset INV Counter</span>
            </a>
            @endif
            ...
            <a href="{{ route('admin.settings.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors {{ request()->routeIs('admin.settings*') ? 'bg-emerald-600/30 text-emerald-300' : 'hover:bg-slate-700 text-slate-300' }}">
