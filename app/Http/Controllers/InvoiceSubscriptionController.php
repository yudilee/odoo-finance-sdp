...
class InvoiceSubscriptionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $defaultColumns = [
            ['id' => 'partner_name', 'label' => 'Customer', 'visible' => true, 'width' => '200', 'sortable' => true, 'align' => 'left'],
            ['id' => 'so_name', 'label' => 'SO Number', 'visible' => true, 'width' => '110', 'sortable' => true, 'align' => 'left'],
            ['id' => 'rental_status', 'label' => 'Rental Status', 'visible' => true, 'width' => '90', 'sortable' => true, 'align' => 'center'],
            ['id' => 'rental_type', 'label' => 'Rental Type', 'visible' => false, 'width' => '100', 'sortable' => true, 'align' => 'center'],
            ['id' => 'period_type', 'label' => 'Period Type', 'visible' => false, 'width' => '100', 'sortable' => true, 'align' => 'center'],
            ['id' => 'product_name', 'label' => 'Vehicle/Product', 'visible' => true, 'width' => '170', 'sortable' => true, 'align' => 'left'],
            ['id' => 'license_plate', 'label' => 'Serial Number', 'visible' => true, 'width' => '90', 'sortable' => true, 'align' => 'center'],
            ['id' => 'period_start', 'label' => 'Rental Period', 'visible' => true, 'width' => '130', 'sortable' => true, 'align' => 'center'],
            ['id' => 'period_end', 'label' => 'Period End', 'visible' => false, 'width' => '100', 'sortable' => true, 'align' => 'center'],
            ['id' => 'actual_start_rental', 'label' => 'Actual Start', 'visible' => false, 'width' => '110', 'sortable' => true, 'align' => 'center'],
            ...
            ['id' => 'transaction_code', 'label' => 'Kode Transaksi', 'visible' => false, 'width' => '110', 'sortable' => true, 'align' => 'center'],
            ...
            ['id' => 'synced_at', 'label' => 'Synced At', 'visible' => false, 'width' => '130', 'sortable' => true, 'align' => 'center'],
        ];
