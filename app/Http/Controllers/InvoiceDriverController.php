...
class InvoiceDriverController extends Controller
{
    ...
    public function getSyncIds(Request $request)
    {
        ...
        try {
            ...
            $result = $odoo->getInvoiceDriverIds(
    ...
    public function syncBatch(Request $request)
    {
        ...
        try {
            $odoo = new OdooService();
            $result = $odoo->fetchInvoiceDriversByIds($request->input('ids'));
     ...
     */
    public function refreshFromOdoo(InvoiceDriver $invoice)
    {
        try {
            $odoo = new OdooService();
            ...
            $result = $odoo->fetchInvoiceDriversByIds($ids);
