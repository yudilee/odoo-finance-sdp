...
class InvoiceDriverController extends Controller
{
    ...
    public function sync(Request $request)
    {
        ...
        try {
            ...
            // Save to database
            $savedCount = $this->saveInvoiceDrivers($result['data']);
    ...
    /**
     * Save invoice driver entries to database (upsert by name)
     */
    protected function saveInvoiceDrivers(array $entries): int
    {
        $count = 0;
